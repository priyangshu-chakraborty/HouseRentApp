   ...
   return (
      <div style={{ backgroundColor: 'black', color: 'white', padding: '20px' }}>
         <div className="mt-4 filter-container text-center">
            ...
            />
            <select value={filterPropertyAdType} onChange={(e) => setPropertyAdType(e.target.value)} style={{ margin: '0 5px' }}>
               <option value="">All Ad Types</option>
               <option value="sale">Sale</option>
               <option value="rent">Rent</option>
            </select>
            <select value={filterPropertyType} onChange={(e) => setPropertyType(e.target.value)} style={{ margin: '0 5px' }}>
            ...
            {filteredProperties && filteredProperties.length > 0 ? (
               filteredProperties.map((property) => (
                  ...
                  >
                     <Card.Body>
                        <Card.Title>
                           <img src={`http://localhost:8000${property.propertyImage[0].path}`} alt='photos' style={{ width: '100%' }} />
                        </Card.Title>
                        <Card.Text>
                           ...
                           {loggedIn && (
                              <>
                                 ...
                                 <p style={{ fontWeight: 600 }} className="my-1">Availability:</p> {property.isAvailable} <br />
                        ...
                        </Card.Text>
                        {
                           !loggedIn ? (
                              <>
                                 ...
                                 <Link to={'/login'}>
                                    <Button style={{ float: 'left' }} variant="outline-light">
                                       Get Info
                                    </Button>
                                 </Link>
                              </>
                              ...
                              property.isAvailable === "Available" ? (
                                 <>
                                    <Button onClick={() => handleShow(property._id)} style={{ float: 'right' }} variant="outline-light">
                                       Get Info
                                    </Button>
                                    <Modal show={show && propertyOpen === property._id} onHide={handleClose}>
                                       ...
                                       <Modal.Body>
                                          ...
                                          <div>
                                             ...
                                             <p><b>Property Amount:</b> Rs.{property.propertyAmt}</p>
