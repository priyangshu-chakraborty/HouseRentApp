...
function AddProperty() {
   ...
   return (
      <Container style={{ backgroundColor: 'black', borderRadius: '5px', padding: '30px' }}>
         <div className="card" style={{ backgroundColor: '#2a2a2a', color: 'white', padding: '30px', borderRadius: '10px' }}>
            <Form onSubmit={handleSubmit}>
               <Row className="mb-3">
                  <Form.Group as={Col} md="4">
                     <Form.Group as={Col}>
                        <Form.Label style={{ color: 'white' }}>Property type</Form.Label>
                  ...
                  <Form.Group as={Col} md="4">
                     <Form.Group as={Col}>
                        <Form.Label style={{ color: 'white' }}>Property Ad type</Form.Label>
                  ...
                  <Form.Group as={Col} md="4">
                     <Form.Label style={{ color: 'white' }}>Property Full Address</Form.Label>
               ...
               <Row className="mb-3">
                  <Form.Group as={Col} md="6">
                     <Form.Label style={{ color: 'white' }}>Property Images</Form.Label>
                     <Form.Control
                        type="file"
                        placeholder="images"
                        required
                  ...
                  <Form.Group as={Col} md="3">
                     <Form.Label style={{ color: 'white' }}>Owner Contact No.</Form.Label>
                  ...
                  <Form.Group as={Col} md="3">
                     <Form.Label style={{ color: 'white' }}>Property Amt.</Form.Label>
